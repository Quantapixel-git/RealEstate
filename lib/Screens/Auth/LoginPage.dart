...
import 'package:real_estate_quantapixel/Screens/Auth/ForgotPassword.dart';
import 'package:real_estate_quantapixel/Screens/Auth/SignupPage.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void loadUserData() async {
    ...
    if (name != null && mobile != null && id != null) {
      print("User  Data Loaded: $name, $mobile, $id");
    }
  }
